...
#'
#' @examples
#' plot(projectq3a(n = 10000, pdf = d2dunif, a = 0, b = 1, C = 1))
#' plot(projectq3a(n = 10000, pdf = d2dunif, a = 0, b = 2, C = 1/4, min = 0, max = 2))
#' plot(projectq3a(n = 10000, d2dcirclecontour, a = -1, b = 1, C = 1))
projectq3a <- function(n, pdf, a, b, C, ...) {
